...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferOne[2], consumerID, 'Missing/Invalid ownerID')
        assert.equal(resultBufferOne[3], originFarmerID, 'Missing/Invalid originFarmerID')
        assert.equal(resultBufferOne[4], originFarmName, 'Missing/Invalid originFarmName')
        assert.equal(resultBufferOne[5], originFarmInformation, 'Missing/Invalid originFarmInformation')
        assert.equal(resultBufferOne[6], originFarmLatitude, 'Missing/Invalid originFarmLatitude')
        assert.equal(resultBufferOne[7], originFarmLongitude, 'Missing/Invalid originFarmLongitude')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[2], productID, 'Missing/Invalid productID')
        assert.equal(resultBufferTwo[3], productNotes, 'Missing/Invalid originFarmerID')
        assert.equal(resultBufferTwo[4], productPrice, 'Missing/Invalid originFarmName')
        assert.equal(resultBufferTwo[5], 7, 'Missing/Invalid originFarmInformation') // Purchased
        assert.equal(resultBufferTwo[6], distributorID, 'Missing/Invalid originFarmLatitude')
        assert.equal(resultBufferTwo[7], retailerID, 'Missing/Invalid originFarmLongitude')
        assert.equal(resultBufferTwo[8], consumerID, 'Invalid  State') // Purchased
